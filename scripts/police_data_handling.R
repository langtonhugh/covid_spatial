...
lsoa_ew_complete_sf <- left_join(lsoa_ew_complete_sf, urban_df, by = c("geo_code" = "LSOA11CD"))
...
# Creating queens continuity matrix seems problematic due to memory.
# lsoa_nb <- poly2nb(pl = lsoa_ew_complete_sf, queen = TRUE)

# Save lsoa_ew_complete_sf object as shapefile for use in GeoDa.
# st_write(obj = lsoa_ew_complete_sf, dsn = "data/lsoa_ew_complete_sf.shp")

# Queens contuinity matrix created in GeoDa Version 1.14.0. Descriptive statistics screenshot
# has been saved in the 'img' folder of this project. Warning message over 'islands' to be resolved.
